...
* [cAdvisor](https://github.com/google/cadvisor) ⭐ 19,404 | 🐛 62 | 🌐 Go | 📅 2026-09-02 - Container Advisor that provides container users an understanding of the resource usage and performance characteristics of their running containers.
* [ctop](https://github.com/bcicen/ctop) ⭐ 17,835 | 🐛 120 | 🌐 Go | 📅 2024-07-08 - Top-like interface for container metrics.
* [Node-exporter](https://github.com/prometheus/node_exporter) ⭐ 13,763 | 🐛 307 | 🌐 Go | 📅 2026-09-03 - Prometheus stack, Exporter for machine metrics.
...
* [Elastic Beats](https://github.com/elastic/beats) ⭐ 12,643 | 🐛 1,041 | 🌐 Go | 📅 2026-09-04 - Lightweight shippers for Elasticsearch & Logstash, Elastic stack.
...
* [Elastic Beats](https://github.com/elastic/beats) ⭐ 12,643 | 🐛 1,041 | 🌐 Go | 📅 2026-09-04 - Lightweight shippers for Elasticsearch & Logstash, Elastic stack.
* [Grafana Alloy](https://github.com/grafana/alloy) ⭐ 3,509 | 🐛 1,219 | 🌐 Go | 📅 2026-09-05 - Grafana's OpenTelemetry Collector distribution that unifies logs, metrics, and traces in a single agent; the supported successor to Promtail and Grafana Agent.
...
* [Locust](https://github.com/locustio/locust) ⭐ 28,127 | 🐛 5 | 🌐 Python | 📅 2026-08-26 - Easy-to-use, distributed, user load testing tool. It is intended for load-testing web sites (or other systems) and figuring out how many concurrent users a system can handle.
...
* [ghz](https://github.com/bojand/ghz) ⭐ 3,352 | 🐛 101 | 🌐 Go | 📅 2026-09-01 - Simple gRPC benchmarking and load testing tool inspired by hey and grpcurl.
* [Yandex Tank](https://github.com/yandex/yandex-tank) ⭐ 2,596 | 🐛 84 | 🌐 Python | 📅 2026-09-03 - Yandex.Tank is an extensible open source load testing tool for advanced Linux users which is especially good as a part of an automated load testing suite.
...
* [Telegraf](https://github.com/influxdata/telegraf) ⭐ 17,796 | 🐛 413 | 🌐 Go | 📅 2026-09-04 - TICK stack, The plugin-driven server agent for collecting & reporting metrics.
...
* [Loki](https://github.com/grafana/loki) ⭐ 28,838 | 🐛 1,741 | 🌐 Go | 📅 2026-09-05 - Horizontally-scalable, highly-available, multi-tenant log aggregation system inspired by Prometheus.
...
* [Logbook](https://github.com/zalando/logbook) ⭐ 2,063 | 🐛 35 | 🌐 Java | 📅 2026-09-01 - Extensible Java library to enable complete request and response logging for different client- and server-side technologies.
...
* [GreptimeDB](https://github.com/GreptimeTeam/greptimedb) ⭐ 6,623 | 🐛 246 | 🌐 Rust | 📅 2026-09-04 - Open-source, cloud-native observability database with unified SQL and PromQL support for metrics, logs, and traces.
...
* [Grafana Tempo](https://github.com/grafana/tempo) ⭐ 5,464 | 🐛 176 | 🌐 Go | 📅 2026-09-05 - Open source, easy-to-use and high-scale distributed tracing backend.
...
* [Neo4j](https://github.com/neo4j/neo4j) ⭐ 17,190 | 🐛 246 | 🌐 Java | 📅 2026-08-24 - Graphs for Everyone.
* [ArangoDB](https://www.arangodb.com/) - Natively store data for graph, document and search needs.

### SQL Database

* [PostgreSQL](https://github.com/postgres/postgres) ⭐ 22,002 | 🐛 0 | 🌐 C | 📅 2026-09-05 - Open source relational database.
...
* [Kibana](https://github.com/elastic/kibana) ⭐ 21,281 | 🐛 14,753 | 🌐 TypeScript | 📅 2026-09-05 - Elastic stack.
...
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 132 | 🐛 99 | 🌐 TypeScript | 📅 2026-09-05 - AI-powered multi-cluster Kubernetes dashboard with real-time observability across edge and cloud clusters, CNCF project integrations (Prometheus, Grafana, Istio, Falco, OPA), and 160+ monitoring cards.
* [StatLite](https://github.com/PVRLabs/statlite) ⭐ 132 | 🐛 0 | 🌐 Go | 📅 2026-09-04 - Ultra-light self-hosted metrics dashboard for small Spring Boot deployments. Polls Spring Boot Actuator directly, stores samples in SQLite, and runs as a single Go binary.
...
* [BlueWave Uptime](https://github.com/bluewave-labs/bluewave-uptime) ⭐ 10,789 | 🐛 113 | 🌐 TypeScript | 📅 2026-09-04 - Open-source, self-hosted monitoring tool built with React.js, Node.js, and MongoDB, designed to track server uptime, response times, and incidents in real-time with beautiful visualizations.
...
* [Vector](https://github.com/timberio/vector) ⭐ 22,511 | 🐛 2,509 | 🌐 Rust | 📅 2026-09-05 - High-performance observability data router. It makes collecting, transforming, and sending logs, metrics, and events easy. It decouples data collection & routing from your services, giving you control and data ownership, among many other benefits.
...
* [Prometheus Alertmanager](https://github.com/prometheus/alertmanager) ⭐ 8,604 | 🐛 431 | 🌐 Go | 📅 2026-09-03 - Prometheus stack, Prometheus Alertmanager, written in go.
...
* [Langfuse](https://github.com/langfuse/langfuse) ⭐ 34,211 | 🐛 900 | 🌐 TypeScript | 📅 2026-09-04 - Open source LLM engineering platform for observability, metrics, evals, prompt management and datasets. Integrates with OpenTelemetry, LangChain, OpenAI SDK, LiteLLM, and more.
* [Opik](https://github.com/comet-ml/opik) ⭐ 21,802 | 🐛 255 | 🌐 Python | 📅 2026-09-04 - Debug, evaluate, and monitor LLM applications, RAG systems, and agentic workflows with comprehensive tracing, automated evaluations, and production-ready dashboards.
* [Arize Phoenix](https://github.com/Arize-ai/phoenix) ⭐ 11,332 | 🐛 973 | 🌐 Python | 📅 2026-09-05 - Open-source AI observability platform for tracing, evaluation, datasets, experiments, prompt management and playground. Built on OpenTelemetry with Python and TypeScript support.
* [Helicone](https://github.com/Helicone/helicone) ⭐ 6,132 | 🐛 156 | 🌐 TypeScript | 📅 2026-08-31 - Open source LLM observability platform and AI Gateway. One line of code to monitor, evaluate, and experiment across 100+ providers.
* [Agenta](https://github.com/Agenta-AI/agenta) ⭐ 4,684 | 🐛 320 | 🌐 TypeScript | 📅 2026-09-05 - Open-source LLMOps platform for prompt playground, prompt management, LLM evaluation, and observability.
* [Latitude](https://github.com/latitude-dev/latitude-llm) ⭐ 4,626 | 🐛 63 | 🌐 TypeScript | 📅 2026-09-04 - Open-source LLM observability and evaluation platform. Traces, monitors, and evaluates AI agents in production, clusters failures into issues, and generates evals from real-world failures. Built on OpenTelemetry with OpenInference and OpenLLMetry support.
* [Pydantic Logfire](https://github.com/pydantic/logfire) ⭐ 4,454 | 🐛 188 | 🌐 Python | 📅 2026-09-05 - AI observability platform for production LLM and agent systems. Built on OpenTelemetry with first-class Pydantic AI support.
* [Laminar](https://github.com/lmnr-ai/lmnr) ⭐ 3,224 | 🐛 116 | 🌐 TypeScript | 📅 2026-09-04 - Open-source observability and analytics platform purpose-built for AI agents. Built in Rust for performance.
* [OpenLIT](https://github.com/openlit/openlit) ⭐ 2,740 | 🐛 74 | 🌐 TypeScript | 📅 2026-09-04 - OTel-native observability and evals for LLMs and GPUs.
...
* [Lookspan](https://github.com/JoniMartin27/lookspan) ⭐ 7 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-04 - Local-first observability for AI agents. One command (`npx lookspan`) runs a dashboard with traces, a timeline/waterfall view, cost tracking, replay & LLM-as-judge, and datasets. MCP-native, with OpenAI/Anthropic drop-ins and an OpenTelemetry receiver — all data stays on your machine.
...
* [onWatch](https://github.com/onllm-dev/onwatch) ⭐ 728 | 🐛 11 | 🌐 Go | 📅 2026-08-20 - Open-source Go CLI that tracks AI API quota usage across 7 providers. Background daemon with SQLite storage, Material Design 3 web dashboard, and zero telemetry.
...
* [ax](https://github.com/Necmttn/ax) ⭐ 104 | 🐛 36 | 🌐 TypeScript | 📅 2026-08-26 - Local telemetry for AI coding agents.
...
* [NVTOP](https://github.com/Syllo/nvtop) ⭐ 10,970 | 🐛 148 | 🌐 C | 📅 2026-05-06 - Task monitor for GPUs and accelerators, similar to htop. Multi-vendor support: NVIDIA, AMD, Intel, Apple, Huawei Ascend, Qualcomm Adreno and more.
* [nvitop](https://github.com/XuehaiPan/nvitop) ⭐ 7,137 | 🐛 19 | 🌐 Python | 📅 2026-07-27 - Interactive NVIDIA GPU process viewer with rich Python API. Ships nvitop-exporter for Prometheus metrics and Grafana dashboards, plus ResourceMetricCollector API for custom monitoring and ML framework callbacks.
* [NVIDIA DCGM Exporter](https://github.com/NVIDIA/dcgm-exporter) ⭐ 1,859 | 🐛 187 | 🌐 Go | 📅 2026-09-02 - Official NVIDIA Prometheus exporter for GPU metrics via DCGM. Kubernetes-native with Helm support, Grafana dashboards, per-process GPU metrics, MIG support, and TLS/auth.
* [nvidia\_gpu\_exporter](https://github.com/utkuozdemir/nvidia_gpu_exporter) ⭐ 1,550 | 🐛 6 | 🌐 Go | 📅 2026-09-03 - Lightweight Prometheus exporter for NVIDIA GPUs using nvidia-smi. No DCGM or C bindings required. Works on Linux and Windows with auto-discovered metric fields and Grafana dashboard.
...
* [piqc](https://github.com/paralleliq/piqc) ⭐ 27 | 🐛 8 | 🌐 Python | 📅 2026-09-04 - Model-aware GPU waste scanner for Kubernetes inference clusters. Detects tier misplacement, idle capacity, OOM risk, and CPU:GPU imbalance, each quantified in dollars. Read-only, deploys as a Kubernetes Job.

## 12. Application Performance Monitoring Solutions (APM)

* [Zabbix](https://github.com/zabbix/zabbix) ⭐ 6,341 | 🐛 108 | 🌐 Go Template | 📅 2026-09-04 - Real-time monitoring of IT components and services, such as networks, servers, VMs, applications and the cloud.
* [DeepFlow](https://github.com/deepflowio/deepflow) ⭐ 4,254 | 🐛 269 | 🌐 Go | 📅 2026-09-04 - Implemented Zero Code data collection with eBPF for metrics, distributed tracing, request logs and function profiling, and is further integrated with SmartEncoding to achieve Full Stack correlation and efficient access to all observability data.
* [Odigos](https://github.com/keyval-dev/odigos) ⭐ 3,675 | 🐛 109 | 🌐 Go | 📅 2026-09-04 - Observability Control Plane.
* [DataBuff](https://github.com/databufflabs/databuff) ⭐ 655 | 🐛 12 | 🌐 Java | 📅 2026-09-02 - Open-source AI-native OpenTelemetry APM with an LLM-powered multi-agent workspace for querying traces, service topology, RED metrics, and alerts in natural language.
...
* [SigNoz](https://github.com/SigNoz/signoz) ⭐ 32,014 | 🐛 1,537 | 🌐 TypeScript | 📅 2026-09-04 - Monitor your applications and troubleshoot problems in your deployed applications, an open-source alternative to DataDog, New Relic, etc.
...
* [rrweb](https://github.com/rrweb-io/rrweb) ⭐ 20,113 | 🐛 429 | 🌐 TypeScript | 📅 2026-09-04 - Open-source session replay library that records the DOM and user interactions as a typed JSON event stream and replays them. Powers the session replay features of Sentry, PostHog, Amplitude, and Highlight.
...
* [Spring PetClinic Sample Application](https://github.com/spring-petclinic/spring-petclinic-microservices) ⭐ 2,194 | 🐛 12 | 🌐 Java | 📅 2026-08-21 - Distributed version of the Spring PetClinic Sample Application built with Spring Cloud.
...
* [Grafana tns](https://github.com/grafana/tns) ⭐ 241 | 🐛 23 | 🌐 Jsonnet | 📅 2026-09-05 - Observability Demo App.
...
* [OpenChainBench](https://github.com/ChainBench/OpenChainBench) ⭐ 7 | 🐛 11 | 🌐 Go | 📅 2026-09-04 - Open benchmark stack for Blockchain RPC providers. Multi-region harnesses scrape live tx-landing, latency and finality metrics; Next.js front-end exposes the dashboards and the raw Prometheus data ([website](https://openchainbench.com)).
