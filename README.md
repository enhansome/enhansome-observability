...
* [cAdvisor](https://github.com/google/cadvisor) ⭐ 19,438 | 🐛 65 | 🌐 Go | 📅 2026-09-18 - Container Advisor that provides container users an understanding of the resource usage and performance characteristics of their running containers.
* [ctop](https://github.com/bcicen/ctop) ⭐ 17,839 | 🐛 120 | 🌐 Go | 📅 2024-07-08 - Top-like interface for container metrics.
* [Node-exporter](https://github.com/prometheus/node_exporter) ⭐ 13,794 | 🐛 317 | 🌐 Go | 📅 2026-09-03 - Prometheus stack, Exporter for machine metrics.
...
* [Elastic Beats](https://github.com/elastic/beats) ⭐ 12,655 | 🐛 1,073 | 🌐 Go | 📅 2026-09-21 - Lightweight shippers for Elasticsearch & Logstash, Elastic stack.
...
* [Kube State Metrics](https://github.com/kubernetes/kube-state-metrics) ⭐ 6,205 | 🐛 112 | 🌐 Go | 📅 2026-09-17 - The kube-state-metrics is a simple service that listens to the Kubernetes API server and generates metrics about the state of the objects.
...
* [Elastic Beats](https://github.com/elastic/beats) ⭐ 12,655 | 🐛 1,073 | 🌐 Go | 📅 2026-09-21 - Lightweight shippers for Elasticsearch & Logstash, Elastic stack.
* [Grafana Alloy](https://github.com/grafana/alloy) ⭐ 3,549 | 🐛 1,235 | 🌐 Go | 📅 2026-09-21 - Grafana's OpenTelemetry Collector distribution that unifies logs, metrics, and traces in a single agent; the supported successor to Promtail and Grafana Agent.
...
* [Locust](https://github.com/locustio/locust) ⭐ 28,171 | 🐛 3 | 🌐 Python | 📅 2026-09-20 - Easy-to-use, distributed, user load testing tool. It is intended for load-testing web sites (or other systems) and figuring out how many concurrent users a system can handle.
...
* [Yandex Tank](https://github.com/yandex/yandex-tank) ⭐ 2,597 | 🐛 86 | 🌐 Python | 📅 2026-09-19 - Yandex.Tank is an extensible open source load testing tool for advanced Linux users which is especially good as a part of an automated load testing suite.
* [Taurus](https://github.com/Blazemeter/taurus) ⭐ 2,113 | 🐛 40 | 🌐 Python | 📅 2026-09-18 - Relies on JMeter, Gatling, Locust.io, Grinder and Selenium WebDriver as its underlying tools. Free and open source under Apache 2.0 License.
...
* [RocketMQ](https://github.com/apache/incubator-rocketmq) ⭐ 22,614 | 🐛 673 | 🌐 Java | 📅 2026-09-21 - A low latency, reliable, scalable, easy to use message oriented middleware born from alibaba massive messaging business.
* [Aeron](https://github.com/real-logic/Aeron) ⭐ 8,883 | 🐛 20 | 🌐 Java | 📅 2026-09-20 - Efficient reliable UDP unicast, UDP multicast, and IPC message transport.
* [Disque](https://github.com/antirez/disque) ⭐ 8,073 | 🐛 59 | 🌐 C | 📅 2021-03-17 - Distributed message broker.
* [VerneMQ](https://github.com/vernemq/vernemq) ⭐ 3,635 | 🐛 168 | 🌐 Erlang | 📅 2026-09-17 - Open source software, extendable, and enterprise support is available.
...
* [Telegraf](https://github.com/influxdata/telegraf) ⭐ 17,818 | 🐛 410 | 🌐 Go | 📅 2026-09-18 - TICK stack, The plugin-driven server agent for collecting & reporting metrics.

<!--lint ignore double-link-->

* [statsd](https://github.com/statsd/statsd) ⭐ 18,075 | 🐛 92 | 🌐 JavaScript | 📅 2025-05-20 - A network daemon that runs on the Node.js platform and listens for statistics, like counters and timers, sent over UDP or TCP and sends aggregates to one or more pluggable backend services.
...
* [Loki](https://github.com/grafana/loki) ⭐ 28,920 | 🐛 1,535 | 🌐 Go | 📅 2026-09-21 - Horizontally-scalable, highly-available, multi-tenant log aggregation system inspired by Prometheus.
* [logdy](https://github.com/logdyhq/logdy-core) ⭐ 2,294 | 🐛 37 | 🌐 Go | 📅 2025-08-25 - Supercharge terminal logs with web browser UI and low-code. It's like jq, tail, less, grep and awk merged together and available in a clean UI. Self-hosted, single binary.
...
* [GreptimeDB](https://github.com/GreptimeTeam/greptimedb) ⭐ 6,690 | 🐛 281 | 🌐 Rust | 📅 2026-09-21 - Open-source, cloud-native observability database with unified SQL and PromQL support for metrics, logs, and traces.
* [Netflix Atlas](https://github.com/Netflix/atlas) ⭐ 3,565 | 🐛 8 | 🌐 Scala | 📅 2026-09-18 - Atlas features in-memory data storage, allowing it to gather and report very large numbers of metrics, very quickly.
...
* [Trickster](https://github.com/Comcast/trickster) ⭐ 2,091 | 🐛 14 | 🌐 Go | 📅 2026-09-18 - Open Source HTTP Reverse Proxy Cache and Time Series Dashboard Accelerator.

### "Meta Projects" (data storage, multi-tenant, aggregation, high availability, etc)

* [Cortex](https://github.com/cortexproject/cortex) ⭐ 5,864 | 🐛 342 | 🌐 Go | 📅 2026-09-21 - Horizontally scalable, highly available, multi-tenant, long term storage for Prometheus.
* [M3](https://github.com/m3db/m3) ⭐ 4,899 | 🐛 213 | 🌐 Go | 📅 2026-09-21 - Distributed TSDB and Query Engine, Prometheus Sidecar, Metrics Aggregator, and more such as Graphite storage and query engine.
...
* [Grafana Tempo](https://github.com/grafana/tempo) ⭐ 5,481 | 🐛 215 | 🌐 Go | 📅 2026-09-21 - Open source, easy-to-use and high-scale distributed tracing backend.
...
* [Neo4j](https://github.com/neo4j/neo4j) ⭐ 17,247 | 🐛 251 | 🌐 Java | 📅 2026-09-10 - Graphs for Everyone.
* [ArangoDB](https://www.arangodb.com/) - Natively store data for graph, document and search needs.

### SQL Database

* [PostgreSQL](https://github.com/postgres/postgres) ⭐ 22,171 | 🐛 0 | 🌐 C | 📅 2026-09-20 - Open source relational database.
...
* [Flame Scope](https://github.com/Netflix/flamescope) ⭐ 3,120 | 🐛 40 | 🌐 Python | 📅 2023-10-06 - FlameScope is a visualization tool for exploring different time ranges as Flame Graphs.
...
* [Kibana](https://github.com/elastic/kibana) ⭐ 21,293 | 🐛 14,618 | 🌐 TypeScript | 📅 2026-09-21 - Elastic stack.
...
* [StatLite](https://github.com/PVRLabs/statlite) ⭐ 139 | 🐛 0 | 🌐 Go | 📅 2026-09-21 - Ultra-light self-hosted metrics dashboard for small Spring Boot deployments. Polls Spring Boot Actuator directly, stores samples in SQLite, and runs as a single Go binary.
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 137 | 🐛 10 | 🌐 TypeScript | 📅 2026-09-21 - AI-powered multi-cluster Kubernetes dashboard with real-time observability across edge and cloud clusters, CNCF project integrations (Prometheus, Grafana, Istio, Falco, OPA), and 160+ monitoring cards.
...
* [BlueWave Uptime](https://github.com/bluewave-labs/bluewave-uptime) ⭐ 10,865 | 🐛 125 | 🌐 TypeScript | 📅 2026-09-21 - Open-source, self-hosted monitoring tool built with React.js, Node.js, and MongoDB, designed to track server uptime, response times, and incidents in real-time with beautiful visualizations.
...
* [Prometheus Alertmanager](https://github.com/prometheus/alertmanager) ⭐ 8,623 | 🐛 416 | 🌐 Go | 📅 2026-09-20 - Prometheus stack, Prometheus Alertmanager, written in go.
* [Kapacitor](https://github.com/influxdata/kapacitor) ⭐ 2,377 | 🐛 834 | 🌐 Go | 📅 2026-09-18 - TICK stack, written in go.
* [Haystack](https://expediadotcom.github.io/haystack/) - A resilient, scalable tracing and analysis system.
...
* [observability-mcp](https://github.com/ThoTischner/observability-mcp) ⭐ 6 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-21 - Cross-signal anomaly detection (z-score) over Prometheus metrics and Loki logs, exposed to AI agents through the Model Context Protocol. Pluggable connectors for additional backends, weighted health scoring, Web UI, and an ArtifactHub-listed Helm chart.
...
* [Langfuse](https://github.com/langfuse/langfuse) ⭐ 34,867 | 🐛 935 | 🌐 TypeScript | 📅 2026-09-21 - Open source LLM engineering platform for observability, metrics, evals, prompt management and datasets. Integrates with OpenTelemetry, LangChain, OpenAI SDK, LiteLLM, and more.
* [Opik](https://github.com/comet-ml/opik) ⭐ 22,172 | 🐛 301 | 🌐 Python | 📅 2026-09-21 - Debug, evaluate, and monitor LLM applications, RAG systems, and agentic workflows with comprehensive tracing, automated evaluations, and production-ready dashboards.
* [Arize Phoenix](https://github.com/Arize-ai/phoenix) ⭐ 11,558 | 🐛 1,029 | 🌐 Python | 📅 2026-09-20 - Open-source AI observability platform for tracing, evaluation, datasets, experiments, prompt management and playground. Built on OpenTelemetry with Python and TypeScript support.
* [Helicone](https://github.com/Helicone/helicone) ⭐ 6,168 | 🐛 159 | 🌐 TypeScript | 📅 2026-09-16 - Open source LLM observability platform and AI Gateway. One line of code to monitor, evaluate, and experiment across 100+ providers.
* [Agenta](https://github.com/Agenta-AI/agenta) ⭐ 4,769 | 🐛 390 | 🌐 TypeScript | 📅 2026-09-21 - Open-source LLMOps platform for prompt playground, prompt management, LLM evaluation, and observability.
* [Latitude](https://github.com/latitude-dev/latitude-llm) ⭐ 4,664 | 🐛 90 | 🌐 TypeScript | 📅 2026-09-21 - Open-source LLM observability and evaluation platform. Traces, monitors, and evaluates AI agents in production, clusters failures into issues, and generates evals from real-world failures. Built on OpenTelemetry with OpenInference and OpenLLMetry support.
* [Pydantic Logfire](https://github.com/pydantic/logfire) ⭐ 4,482 | 🐛 202 | 🌐 Python | 📅 2026-09-20 - AI observability platform for production LLM and agent systems. Built on OpenTelemetry with first-class Pydantic AI support.
* [Laminar](https://github.com/lmnr-ai/lmnr) ⭐ 3,273 | 🐛 113 | 🌐 TypeScript | 📅 2026-09-20 - Open-source observability and analytics platform purpose-built for AI agents. Built in Rust for performance.
* [OpenLIT](https://github.com/openlit/openlit) ⭐ 2,777 | 🐛 99 | 🌐 TypeScript | 📅 2026-09-19 - OTel-native observability and evals for LLMs and GPUs.
...
* [Nika](https://github.com/supernovae-st/nika) ⭐ 87 | 🐛 140 | 🌐 Rust | 📅 2026-09-21 - Workflow engine for AI where observability is built into the runtime: every run emits a typed event stream and a hash-chained, tamper-evident trace (`nika trace verify` · `nika trace show`), with static cost floors before the run and per-task cost rows after. Local-first, single Rust binary, AGPL.
...
* [Lookspan](https://github.com/JoniMartin27/lookspan) ⭐ 7 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-20 - Local-first observability for AI agents. One command (`npx lookspan`) runs a dashboard with traces, a timeline/waterfall view, cost tracking, replay & LLM-as-judge, and datasets. MCP-native, with OpenAI/Anthropic drop-ins and an OpenTelemetry receiver — all data stays on your machine.
...
* [OpenLLMetry](https://github.com/traceloop/openllmetry) ⭐ 7,441 | 🐛 684 | 🌐 Python | 📅 2026-09-17 - Open-source observability for LLM applications, based on OpenTelemetry.
...
* [Manifest](https://github.com/mnfst/manifest) ⭐ 7,537 | 🐛 108 | 🌐 TypeScript | 📅 2026-09-20 - Open-source real-time cost observability for AI agents. Tracks tokens, costs, messages, and model usage. Self-hostable, privacy-focused, and OTLP-native.
* [onWatch](https://github.com/onllm-dev/onwatch) ⭐ 744 | 🐛 4 | 🌐 Go | 📅 2026-09-20 - Open-source Go CLI that tracks AI API quota usage across 7 providers. Background daemon with SQLite storage, Material Design 3 web dashboard, and zero telemetry.
...
* [NVTOP](https://github.com/Syllo/nvtop) ⭐ 11,018 | 🐛 134 | 🌐 C | 📅 2026-09-20 - Task monitor for GPUs and accelerators, similar to htop. Multi-vendor support: NVIDIA, AMD, Intel, Apple, Huawei Ascend, Qualcomm Adreno and more.
...
* [NVIDIA DCGM Exporter](https://github.com/NVIDIA/dcgm-exporter) ⭐ 1,876 | 🐛 133 | 🌐 Go | 📅 2026-09-18 - Official NVIDIA Prometheus exporter for GPU metrics via DCGM. Kubernetes-native with Helm support, Grafana dashboards, per-process GPU metrics, MIG support, and TLS/auth.
* [nvidia\_gpu\_exporter](https://github.com/utkuozdemir/nvidia_gpu_exporter) ⭐ 1,556 | 🐛 7 | 🌐 Go | 📅 2026-09-19 - Lightweight Prometheus exporter for NVIDIA GPUs using nvidia-smi. No DCGM or C bindings required. Works on Linux and Windows with auto-discovered metric fields and Grafana dashboard.
* [HomeLab Monitor](https://github.com/SikamikanikoBG/homelab-monitor) ⭐ 206 | 🐛 14 | 🌐 Python | 📅 2026-09-20 - Self-hosted dashboard that shows which Docker container is actually holding the GPU - per-container VRAM attribution, not just total utilization. Also covers host vitals, Docker health, systemd services, and multiple machines over SSH. MIT license.
...
* [Zabbix](https://github.com/zabbix/zabbix) ⭐ 6,392 | 🐛 109 | 🌐 Go Template | 📅 2026-09-18 - Real-time monitoring of IT components and services, such as networks, servers, VMs, applications and the cloud.
* [DeepFlow](https://github.com/deepflowio/deepflow) ⭐ 4,277 | 🐛 270 | 🌐 Go | 📅 2026-09-20 - Implemented Zero Code data collection with eBPF for metrics, distributed tracing, request logs and function profiling, and is further integrated with SmartEncoding to achieve Full Stack correlation and efficient access to all observability data.
* [Odigos](https://github.com/keyval-dev/odigos) ⭐ 3,679 | 🐛 166 | 🌐 Go | 📅 2026-09-20 - Observability Control Plane.
...
* [SigNoz](https://github.com/SigNoz/signoz) ⭐ 32,153 | 🐛 1,578 | 🌐 TypeScript | 📅 2026-09-21 - Monitor your applications and troubleshoot problems in your deployed applications, an open-source alternative to DataDog, New Relic, etc.
* [Pinpoint](https://github.com/pinpoint-apm/pinpoint) ⭐ 13,873 | 🐛 542 | 🌐 Java | 📅 2026-09-21 - APM (Application Performance Management) tool for large-scale distributed systems written in Java / PHP/PYTHON.
* [Falcon Plus](https://github.com/open-falcon/falcon-plus) ⚠️ Archived - An open-source and enterprise-level monitoring system.
* [Hubble](https://github.com/cilium/hubble) ⭐ 4,341 | 🐛 44 | 🌐 Makefile | 📅 2026-09-15 - Network, Service & Security Observability for Kubernetes.
...
* [rrweb](https://github.com/rrweb-io/rrweb) ⭐ 20,194 | 🐛 418 | 🌐 TypeScript | 📅 2026-09-18 - Open-source session replay library that records the DOM and user interactions as a typed JSON event stream and replays them. Powers the session replay features of Sentry, PostHog, Amplitude, and Highlight.
* [App Health](https://github.com/sass-maker/app-health) ⭐ 0 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-20 - Privacy-first endpoint health for Node, Go, and OpenTelemetry services; projects only method, normalized route, status, duration, timestamp, and optional release into aggregate views.
...
* [Spring PetClinic Sample Application](https://github.com/spring-petclinic/spring-petclinic-microservices) ⭐ 2,202 | 🐛 12 | 🌐 Java | 📅 2026-09-20 - Distributed version of the Spring PetClinic Sample Application built with Spring Cloud.
...
* [Grafana tns](https://github.com/grafana/tns) ⭐ 241 | 🐛 28 | 🌐 Jsonnet | 📅 2026-09-21 - Observability Demo App.
...
* [OpenChainBench](https://github.com/ChainBench/OpenChainBench) ⭐ 7 | 🐛 13 | 🌐 Go | 📅 2026-09-20 - Open benchmark stack for Blockchain RPC providers. Multi-region harnesses scrape live tx-landing, latency and finality metrics; Next.js front-end exposes the dashboards and the raw Prometheus data ([website](https://openchainbench.com)).
...
* <https://github.com/Enapiuz/awesome-monitoring> ⭐ 426 | 🐛 18 | 📅 2026-08-04
