...
* [cAdvisor](https://github.com/google/cadvisor) ⭐ 19,421 | 🐛 66 | 🌐 Go | 📅 2026-09-09 - Container Advisor that provides container users an understanding of the resource usage and performance characteristics of their running containers.
* [ctop](https://github.com/bcicen/ctop) ⭐ 17,838 | 🐛 120 | 🌐 Go | 📅 2024-07-08 - Top-like interface for container metrics.
* [Node-exporter](https://github.com/prometheus/node_exporter) ⭐ 13,782 | 🐛 314 | 🌐 Go | 📅 2026-09-03 - Prometheus stack, Exporter for machine metrics.
...
* [Elastic Beats](https://github.com/elastic/beats) ⭐ 12,652 | 🐛 1,076 | 🌐 Go | 📅 2026-09-14 - Lightweight shippers for Elasticsearch & Logstash, Elastic stack.
...
* [Kube State Metrics](https://github.com/kubernetes/kube-state-metrics) ⭐ 6,199 | 🐛 111 | 🌐 Go | 📅 2026-09-14 - The kube-state-metrics is a simple service that listens to the Kubernetes API server and generates metrics about the state of the objects.
...
* [Elastic Beats](https://github.com/elastic/beats) ⭐ 12,652 | 🐛 1,076 | 🌐 Go | 📅 2026-09-14 - Lightweight shippers for Elasticsearch & Logstash, Elastic stack.
* [Grafana Alloy](https://github.com/grafana/alloy) ⭐ 3,536 | 🐛 1,238 | 🌐 Go | 📅 2026-09-15 - Grafana's OpenTelemetry Collector distribution that unifies logs, metrics, and traces in a single agent; the supported successor to Promtail and Grafana Agent.
...
* [Locust](https://github.com/locustio/locust) ⭐ 28,156 | 🐛 8 | 🌐 Python | 📅 2026-09-14 - Easy-to-use, distributed, user load testing tool. It is intended for load-testing web sites (or other systems) and figuring out how many concurrent users a system can handle.
...
* [RocketMQ](https://github.com/apache/incubator-rocketmq) ⭐ 22,598 | 🐛 687 | 🌐 Java | 📅 2026-09-15 - A low latency, reliable, scalable, easy to use message oriented middleware born from alibaba massive messaging business.
* [Aeron](https://github.com/real-logic/Aeron) ⭐ 8,865 | 🐛 30 | 🌐 Java | 📅 2026-09-11 - Efficient reliable UDP unicast, UDP multicast, and IPC message transport.
* [Disque](https://github.com/antirez/disque) ⭐ 8,073 | 🐛 59 | 🌐 C | 📅 2021-03-17 - Distributed message broker.
* [VerneMQ](https://github.com/vernemq/vernemq) ⭐ 3,630 | 🐛 174 | 🌐 Erlang | 📅 2026-09-04 - Open source software, extendable, and enterprise support is available.
...
* [Telegraf](https://github.com/influxdata/telegraf) ⭐ 17,803 | 🐛 449 | 🌐 Go | 📅 2026-09-14 - TICK stack, The plugin-driven server agent for collecting & reporting metrics.
...
* [Loki](https://github.com/grafana/loki) ⭐ 28,887 | 🐛 1,619 | 🌐 Go | 📅 2026-09-15 - Horizontally-scalable, highly-available, multi-tenant log aggregation system inspired by Prometheus.
...
* [Logbook](https://github.com/zalando/logbook) ⭐ 2,065 | 🐛 29 | 🌐 Java | 📅 2026-09-15 - Extensible Java library to enable complete request and response logging for different client- and server-side technologies.
...
* [GreptimeDB](https://github.com/GreptimeTeam/greptimedb) ⭐ 6,669 | 🐛 262 | 🌐 Rust | 📅 2026-09-15 - Open-source, cloud-native observability database with unified SQL and PromQL support for metrics, logs, and traces.
...
* [Trickster](https://github.com/Comcast/trickster) ⭐ 2,090 | 🐛 2 | 🌐 Go | 📅 2026-09-14 - Open Source HTTP Reverse Proxy Cache and Time Series Dashboard Accelerator.

### "Meta Projects" (data storage, multi-tenant, aggregation, high availability, etc)

* [Cortex](https://github.com/cortexproject/cortex) ⭐ 5,862 | 🐛 344 | 🌐 Go | 📅 2026-09-14 - Horizontally scalable, highly available, multi-tenant, long term storage for Prometheus.
...
* [Grafana Tempo](https://github.com/grafana/tempo) ⭐ 5,473 | 🐛 194 | 🌐 Go | 📅 2026-09-14 - Open source, easy-to-use and high-scale distributed tracing backend.
...
* [Neo4j](https://github.com/neo4j/neo4j) ⭐ 17,226 | 🐛 252 | 🌐 Java | 📅 2026-09-10 - Graphs for Everyone.
* [ArangoDB](https://www.arangodb.com/) - Natively store data for graph, document and search needs.

### SQL Database

* [PostgreSQL](https://github.com/postgres/postgres) ⭐ 22,106 | 🐛 0 | 🌐 C | 📅 2026-09-15 - Open source relational database.
...
* [Kibana](https://github.com/elastic/kibana) ⭐ 21,288 | 🐛 14,788 | 🌐 TypeScript | 📅 2026-09-15 - Elastic stack.
...
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 135 | 🐛 128 | 🌐 TypeScript | 📅 2026-09-15 - AI-powered multi-cluster Kubernetes dashboard with real-time observability across edge and cloud clusters, CNCF project integrations (Prometheus, Grafana, Istio, Falco, OPA), and 160+ monitoring cards.
...
* [BlueWave Uptime](https://github.com/bluewave-labs/bluewave-uptime) ⭐ 10,811 | 🐛 121 | 🌐 TypeScript | 📅 2026-09-14 - Open-source, self-hosted monitoring tool built with React.js, Node.js, and MongoDB, designed to track server uptime, response times, and incidents in real-time with beautiful visualizations.
...
* [Vector](https://github.com/timberio/vector) ⭐ 22,556 | 🐛 2,487 | 🌐 Rust | 📅 2026-09-15 - High-performance observability data router. It makes collecting, transforming, and sending logs, metrics, and events easy. It decouples data collection & routing from your services, giving you control and data ownership, among many other benefits.
...
* [Prometheus Alertmanager](https://github.com/prometheus/alertmanager) ⭐ 8,612 | 🐛 421 | 🌐 Go | 📅 2026-09-14 - Prometheus stack, Prometheus Alertmanager, written in go.
* [Kapacitor](https://github.com/influxdata/kapacitor) ⭐ 2,377 | 🐛 833 | 🌐 Go | 📅 2026-09-15 - TICK stack, written in go.
* [Haystack](https://expediadotcom.github.io/haystack/) - A resilient, scalable tracing and analysis system.
...
* [observability-mcp](https://github.com/ThoTischner/observability-mcp) ⭐ 6 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-14 - Cross-signal anomaly detection (z-score) over Prometheus metrics and Loki logs, exposed to AI agents through the Model Context Protocol. Pluggable connectors for additional backends, weighted health scoring, Web UI, and an ArtifactHub-listed Helm chart.
...
* [Langfuse](https://github.com/langfuse/langfuse) ⭐ 34,619 | 🐛 961 | 🌐 TypeScript | 📅 2026-09-15 - Open source LLM engineering platform for observability, metrics, evals, prompt management and datasets. Integrates with OpenTelemetry, LangChain, OpenAI SDK, LiteLLM, and more.
* [Opik](https://github.com/comet-ml/opik) ⭐ 22,026 | 🐛 258 | 🌐 Python | 📅 2026-09-15 - Debug, evaluate, and monitor LLM applications, RAG systems, and agentic workflows with comprehensive tracing, automated evaluations, and production-ready dashboards.
* [Arize Phoenix](https://github.com/Arize-ai/phoenix) ⭐ 11,464 | 🐛 994 | 🌐 Python | 📅 2026-09-15 - Open-source AI observability platform for tracing, evaluation, datasets, experiments, prompt management and playground. Built on OpenTelemetry with Python and TypeScript support.
* [Helicone](https://github.com/Helicone/helicone) ⭐ 6,157 | 🐛 156 | 🌐 TypeScript | 📅 2026-09-13 - Open source LLM observability platform and AI Gateway. One line of code to monitor, evaluate, and experiment across 100+ providers.
* [Agenta](https://github.com/Agenta-AI/agenta) ⭐ 4,753 | 🐛 326 | 🌐 TypeScript | 📅 2026-09-14 - Open-source LLMOps platform for prompt playground, prompt management, LLM evaluation, and observability.
* [Latitude](https://github.com/latitude-dev/latitude-llm) ⭐ 4,644 | 🐛 92 | 🌐 TypeScript | 📅 2026-09-15 - Open-source LLM observability and evaluation platform. Traces, monitors, and evaluates AI agents in production, clusters failures into issues, and generates evals from real-world failures. Built on OpenTelemetry with OpenInference and OpenLLMetry support.
* [Pydantic Logfire](https://github.com/pydantic/logfire) ⭐ 4,474 | 🐛 197 | 🌐 Python | 📅 2026-09-15 - AI observability platform for production LLM and agent systems. Built on OpenTelemetry with first-class Pydantic AI support.
* [Laminar](https://github.com/lmnr-ai/lmnr) ⭐ 3,255 | 🐛 121 | 🌐 TypeScript | 📅 2026-09-14 - Open-source observability and analytics platform purpose-built for AI agents. Built in Rust for performance.
* [OpenLIT](https://github.com/openlit/openlit) ⭐ 2,764 | 🐛 61 | 🌐 TypeScript | 📅 2026-09-15 - OTel-native observability and evals for LLMs and GPUs.
...
* [Lookspan](https://github.com/JoniMartin27/lookspan) ⭐ 7 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-14 - Local-first observability for AI agents. One command (`npx lookspan`) runs a dashboard with traces, a timeline/waterfall view, cost tracking, replay & LLM-as-judge, and datasets. MCP-native, with OpenAI/Anthropic drop-ins and an OpenTelemetry receiver — all data stays on your machine.
...
* [OpenLLMetry](https://github.com/traceloop/openllmetry) ⭐ 7,429 | 🐛 677 | 🌐 Python | 📅 2026-08-10 - Open-source observability for LLM applications, based on OpenTelemetry.
...
* [Manifest](https://github.com/mnfst/manifest) ⭐ 7,523 | 🐛 108 | 🌐 TypeScript | 📅 2026-09-15 - Open-source real-time cost observability for AI agents. Tracks tokens, costs, messages, and model usage. Self-hostable, privacy-focused, and OTLP-native.
* [onWatch](https://github.com/onllm-dev/onwatch) ⭐ 739 | 🐛 9 | 🌐 Go | 📅 2026-09-11 - Open-source Go CLI that tracks AI API quota usage across 7 providers. Background daemon with SQLite storage, Material Design 3 web dashboard, and zero telemetry.
...
* [NVIDIA DCGM Exporter](https://github.com/NVIDIA/dcgm-exporter) ⭐ 1,871 | 🐛 191 | 🌐 Go | 📅 2026-09-10 - Official NVIDIA Prometheus exporter for GPU metrics via DCGM. Kubernetes-native with Helm support, Grafana dashboards, per-process GPU metrics, MIG support, and TLS/auth.
* [nvidia\_gpu\_exporter](https://github.com/utkuozdemir/nvidia_gpu_exporter) ⭐ 1,551 | 🐛 7 | 🌐 Go | 📅 2026-09-15 - Lightweight Prometheus exporter for NVIDIA GPUs using nvidia-smi. No DCGM or C bindings required. Works on Linux and Windows with auto-discovered metric fields and Grafana dashboard.
...
* [piqc](https://github.com/paralleliq/piqc) ⭐ 31 | 🐛 8 | 🌐 Python | 📅 2026-09-15 - Model-aware GPU waste scanner for Kubernetes inference clusters. Detects tier misplacement, idle capacity, OOM risk, and CPU:GPU imbalance, each quantified in dollars. Read-only, deploys as a Kubernetes Job.

## 12. Application Performance Monitoring Solutions (APM)

* [Zabbix](https://github.com/zabbix/zabbix) ⭐ 6,374 | 🐛 108 | 🌐 Go Template | 📅 2026-09-15 - Real-time monitoring of IT components and services, such as networks, servers, VMs, applications and the cloud.
* [DeepFlow](https://github.com/deepflowio/deepflow) ⭐ 4,263 | 🐛 272 | 🌐 Go | 📅 2026-09-15 - Implemented Zero Code data collection with eBPF for metrics, distributed tracing, request logs and function profiling, and is further integrated with SmartEncoding to achieve Full Stack correlation and efficient access to all observability data.
* [Odigos](https://github.com/keyval-dev/odigos) ⭐ 3,678 | 🐛 150 | 🌐 Go | 📅 2026-09-15 - Observability Control Plane.
* [DataBuff](https://github.com/databufflabs/databuff) ⭐ 677 | 🐛 11 | 🌐 Java | 📅 2026-09-12 - Open-source AI-native OpenTelemetry APM with an LLM-powered multi-agent workspace for querying traces, service topology, RED metrics, and alerts in natural language.
...
* [SigNoz](https://github.com/SigNoz/signoz) ⭐ 32,101 | 🐛 1,564 | 🌐 TypeScript | 📅 2026-09-15 - Monitor your applications and troubleshoot problems in your deployed applications, an open-source alternative to DataDog, New Relic, etc.
* [Pinpoint](https://github.com/pinpoint-apm/pinpoint) ⭐ 13,870 | 🐛 543 | 🌐 Java | 📅 2026-09-15 - APM (Application Performance Management) tool for large-scale distributed systems written in Java / PHP/PYTHON.
...
* [rrweb](https://github.com/rrweb-io/rrweb) ⭐ 20,166 | 🐛 419 | 🌐 TypeScript | 📅 2026-09-10 - Open-source session replay library that records the DOM and user interactions as a typed JSON event stream and replays them. Powers the session replay features of Sentry, PostHog, Amplitude, and Highlight.
...
* [Grafana tns](https://github.com/grafana/tns) ⭐ 241 | 🐛 23 | 🌐 Jsonnet | 📅 2026-09-15 - Observability Demo App.
...
* [My Awesome Chaos Engineering Repo ;-)](https://github.com/adriannovegil/awesome-chaos-engineering) ⭐ 46 | 🐛 2 | 📅 2026-07-20
