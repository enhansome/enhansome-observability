...
* [cAdvisor](https://github.com/google/cadvisor) ⭐ 19,443 | 🐛 65 | 🌐 Go | 📅 2026-09-18 - Container Advisor that provides container users an understanding of the resource usage and performance characteristics of their running containers.
* [ctop](https://github.com/bcicen/ctop) ⭐ 17,840 | 🐛 120 | 🌐 Go | 📅 2024-07-08 - Top-like interface for container metrics.
* [Node-exporter](https://github.com/prometheus/node_exporter) ⭐ 13,803 | 🐛 321 | 🌐 Go | 📅 2026-09-21 - Prometheus stack, Exporter for machine metrics.
* [Kuberhealthy](https://github.com/kuberhealthy/kuberhealthy) ⭐ 2,268 | 🐛 5 | 🌐 Go | 📅 2026-09-25 - Kubernetes operator for synthetic monitoring and continuous process verification.
...
* [Elastic Beats](https://github.com/elastic/beats) ⭐ 12,656 | 🐛 1,063 | 🌐 Go | 📅 2026-09-24 - Lightweight shippers for Elasticsearch & Logstash, Elastic stack.
...
* [Kube State Metrics](https://github.com/kubernetes/kube-state-metrics) ⭐ 6,210 | 🐛 112 | 🌐 Go | 📅 2026-09-24 - The kube-state-metrics is a simple service that listens to the Kubernetes API server and generates metrics about the state of the objects.
...
* [Elastic Beats](https://github.com/elastic/beats) ⭐ 12,656 | 🐛 1,063 | 🌐 Go | 📅 2026-09-24 - Lightweight shippers for Elasticsearch & Logstash, Elastic stack.
* [Grafana Alloy](https://github.com/grafana/alloy) ⭐ 3,555 | 🐛 1,253 | 🌐 Go | 📅 2026-09-25 - Grafana's OpenTelemetry Collector distribution that unifies logs, metrics, and traces in a single agent; the supported successor to Promtail and Grafana Agent.
...
* [Locust](https://github.com/locustio/locust) ⭐ 28,181 | 🐛 3 | 🌐 Python | 📅 2026-09-21 - Easy-to-use, distributed, user load testing tool. It is intended for load-testing web sites (or other systems) and figuring out how many concurrent users a system can handle.
...
* [Yandex Tank](https://github.com/yandex/yandex-tank) ⭐ 2,597 | 🐛 87 | 🌐 Python | 📅 2026-09-22 - Yandex.Tank is an extensible open source load testing tool for advanced Linux users which is especially good as a part of an automated load testing suite.
...
* [Eventum](https://github.com/eventum-generator/eventum) ⭐ 67 | 🐛 4 | 🌐 Python | 📅 2026-09-08 - Data generation platform for producing synthetic event streams based on templates, scripts or log samples.
...
* [RocketMQ](https://github.com/apache/incubator-rocketmq) ⭐ 22,620 | 🐛 702 | 🌐 Java | 📅 2026-09-23 - A low latency, reliable, scalable, easy to use message oriented middleware born from alibaba massive messaging business.
* [Aeron](https://github.com/real-logic/Aeron) ⭐ 8,897 | 🐛 17 | 🌐 Java | 📅 2026-09-24 - Efficient reliable UDP unicast, UDP multicast, and IPC message transport.
...
* [Telegraf](https://github.com/influxdata/telegraf) ⭐ 17,831 | 🐛 420 | 🌐 Go | 📅 2026-09-23 - TICK stack, The plugin-driven server agent for collecting & reporting metrics.
...
* [Loki](https://github.com/grafana/loki) ⭐ 28,943 | 🐛 1,484 | 🌐 Go | 📅 2026-09-25 - Horizontally-scalable, highly-available, multi-tenant log aggregation system inspired by Prometheus.
* [logdy](https://github.com/logdyhq/logdy-core) ⭐ 2,298 | 🐛 37 | 🌐 Go | 📅 2025-08-25 - Supercharge terminal logs with web browser UI and low-code. It's like jq, tail, less, grep and awk merged together and available in a clean UI. Self-hosted, single binary.
* [Logbook](https://github.com/zalando/logbook) ⭐ 2,065 | 🐛 26 | 🌐 Java | 📅 2026-09-25 - Extensible Java library to enable complete request and response logging for different client- and server-side technologies.
...
* [GreptimeDB](https://github.com/GreptimeTeam/greptimedb) ⭐ 6,711 | 🐛 271 | 🌐 Rust | 📅 2026-09-24 - Open-source, cloud-native observability database with unified SQL and PromQL support for metrics, logs, and traces.
...
* [Cortex](https://github.com/cortexproject/cortex) ⭐ 5,867 | 🐛 343 | 🌐 Go | 📅 2026-09-23 - Horizontally scalable, highly available, multi-tenant, long term storage for Prometheus.
* [M3](https://github.com/m3db/m3) ⭐ 4,903 | 🐛 171 | 🌐 Go | 📅 2026-09-24 - Distributed TSDB and Query Engine, Prometheus Sidecar, Metrics Aggregator, and more such as Graphite storage and query engine.
...
* [Zipkin](https://github.com/openzipkin/zipkin) ⭐ 17,465 | 🐛 175 | 🌐 Java | 📅 2026-08-06 - A distributed tracing system.
* [Grafana Tempo](https://github.com/grafana/tempo) ⭐ 5,488 | 🐛 206 | 🌐 Go | 📅 2026-09-25 - Open source, easy-to-use and high-scale distributed tracing backend.
...
* [PostgreSQL](https://github.com/postgres/postgres) ⭐ 22,187 | 🐛 0 | 🌐 C | 📅 2026-09-25 - Open source relational database.
...
* [Kibana](https://github.com/elastic/kibana) ⭐ 21,301 | 🐛 14,593 | 🌐 TypeScript | 📅 2026-09-25 - Elastic stack.
...
* [StatLite](https://github.com/PVRLabs/statlite) ⭐ 143 | 🐛 0 | 🌐 Go | 📅 2026-09-23 - Ultra-light self-hosted metrics dashboard for small Spring Boot deployments. Polls Spring Boot Actuator directly, stores samples in SQLite, and runs as a single Go binary.
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 139 | 🐛 9 | 🌐 TypeScript | 📅 2026-09-25 - AI-powered multi-cluster Kubernetes dashboard with real-time observability across edge and cloud clusters, CNCF project integrations (Prometheus, Grafana, Istio, Falco, OPA), and 160+ monitoring cards.
...
* [BlueWave Uptime](https://github.com/bluewave-labs/bluewave-uptime) ⭐ 10,887 | 🐛 120 | 🌐 TypeScript | 📅 2026-09-24 - Open-source, self-hosted monitoring tool built with React.js, Node.js, and MongoDB, designed to track server uptime, response times, and incidents in real-time with beautiful visualizations.
...
* [Vector](https://github.com/timberio/vector) ⭐ 22,612 | 🐛 2,488 | 🌐 Rust | 📅 2026-09-25 - High-performance observability data router. It makes collecting, transforming, and sending logs, metrics, and events easy. It decouples data collection & routing from your services, giving you control and data ownership, among many other benefits.
...
* [Sloth](https://github.com/slok/sloth) ⭐ 2,547 | 🐛 26 | 🌐 Go | 📅 2026-09-04 - Easy and simple Prometheus SLO (service level objectives) generator.
...
* [Prometheus Alertmanager](https://github.com/prometheus/alertmanager) ⭐ 8,627 | 🐛 408 | 🌐 Go | 📅 2026-09-24 - Prometheus stack, Prometheus Alertmanager, written in go.
...
* [devalerts](https://github.com/sslinNn/devalerts) ⭐ 0 | 🐛 2 | 🌐 Python | 📅 2026-09-18 - Zero-dependency Python library that sends unhandled exceptions straight to Telegram or Slack, with fingerprint-based dedup and rate-limiting.
...
* [Langfuse](https://github.com/langfuse/langfuse) ⭐ 35,027 | 🐛 940 | 🌐 TypeScript | 📅 2026-09-25 - Open source LLM engineering platform for observability, metrics, evals, prompt management and datasets. Integrates with OpenTelemetry, LangChain, OpenAI SDK, LiteLLM, and more.
* [Opik](https://github.com/comet-ml/opik) ⭐ 22,230 | 🐛 246 | 🌐 Python | 📅 2026-09-25 - Debug, evaluate, and monitor LLM applications, RAG systems, and agentic workflows with comprehensive tracing, automated evaluations, and production-ready dashboards.
* [Arize Phoenix](https://github.com/Arize-ai/phoenix) ⭐ 11,605 | 🐛 1,067 | 🌐 Python | 📅 2026-09-25 - Open-source AI observability platform for tracing, evaluation, datasets, experiments, prompt management and playground. Built on OpenTelemetry with Python and TypeScript support.
* [Helicone](https://github.com/Helicone/helicone) ⭐ 6,176 | 🐛 158 | 🌐 TypeScript | 📅 2026-09-16 - Open source LLM observability platform and AI Gateway. One line of code to monitor, evaluate, and experiment across 100+ providers.
* [Agenta](https://github.com/Agenta-AI/agenta) ⭐ 4,778 | 🐛 341 | 🌐 TypeScript | 📅 2026-09-24 - Open-source LLMOps platform for prompt playground, prompt management, LLM evaluation, and observability.
* [Latitude](https://github.com/latitude-dev/latitude-llm) ⭐ 4,678 | 🐛 71 | 🌐 TypeScript | 📅 2026-09-24 - Open-source LLM observability and evaluation platform. Traces, monitors, and evaluates AI agents in production, clusters failures into issues, and generates evals from real-world failures. Built on OpenTelemetry with OpenInference and OpenLLMetry support.
* [Pydantic Logfire](https://github.com/pydantic/logfire) ⭐ 4,489 | 🐛 208 | 🌐 Python | 📅 2026-09-25 - AI observability platform for production LLM and agent systems. Built on OpenTelemetry with first-class Pydantic AI support.
* [Laminar](https://github.com/lmnr-ai/lmnr) ⭐ 3,279 | 🐛 147 | 🌐 TypeScript | 📅 2026-09-24 - Open-source observability and analytics platform purpose-built for AI agents. Built in Rust for performance.
* [OpenLIT](https://github.com/openlit/openlit) ⭐ 2,792 | 🐛 130 | 🌐 TypeScript | 📅 2026-09-25 - OTel-native observability and evals for LLMs and GPUs.
...
* [OpenLLMetry](https://github.com/traceloop/openllmetry) ⭐ 7,447 | 🐛 699 | 🌐 Python | 📅 2026-09-24 - Open-source observability for LLM applications, based on OpenTelemetry.
...
* [Manifest](https://github.com/mnfst/manifest) ⭐ 7,541 | 🐛 112 | 🌐 TypeScript | 📅 2026-09-24 - Open-source real-time cost observability for AI agents. Tracks tokens, costs, messages, and model usage. Self-hostable, privacy-focused, and OTLP-native.
* [onWatch](https://github.com/onllm-dev/onwatch) ⭐ 743 | 🐛 5 | 🌐 Go | 📅 2026-09-24 - Open-source Go CLI that tracks AI API quota usage across 7 providers. Background daemon with SQLite storage, Material Design 3 web dashboard, and zero telemetry.
* [agenttrace](https://github.com/luoyuctl/agenttrace) ⭐ 135 | 🐛 7 | 🌐 Rust | 📅 2026-09-14 - TUI observability for AI coding agents. Tracks cost, tokens, tool failures, anomalies, health, and CI gates across Claude Code, Codex, Gemini CLI, Aider, and Cursor exports.
* [ax](https://github.com/Necmttn/ax) ⭐ 112 | 🐛 37 | 🌐 TypeScript | 📅 2026-09-14 - Local telemetry for AI coding agents.
...
* [NVTOP](https://github.com/Syllo/nvtop) ⭐ 11,022 | 🐛 134 | 🌐 C | 📅 2026-09-20 - Task monitor for GPUs and accelerators, similar to htop. Multi-vendor support: NVIDIA, AMD, Intel, Apple, Huawei Ascend, Qualcomm Adreno and more.
* [nvitop](https://github.com/XuehaiPan/nvitop) ⭐ 7,164 | 🐛 19 | 🌐 Python | 📅 2026-07-27 - Interactive NVIDIA GPU process viewer with rich Python API. Ships nvitop-exporter for Prometheus metrics and Grafana dashboards, plus ResourceMetricCollector API for custom monitoring and ML framework callbacks.
* [NVIDIA DCGM Exporter](https://github.com/NVIDIA/dcgm-exporter) ⭐ 1,882 | 🐛 134 | 🌐 Go | 📅 2026-09-18 - Official NVIDIA Prometheus exporter for GPU metrics via DCGM. Kubernetes-native with Helm support, Grafana dashboards, per-process GPU metrics, MIG support, and TLS/auth.
* [nvidia\_gpu\_exporter](https://github.com/utkuozdemir/nvidia_gpu_exporter) ⭐ 1,558 | 🐛 7 | 🌐 Go | 📅 2026-09-25 - Lightweight Prometheus exporter for NVIDIA GPUs using nvidia-smi. No DCGM or C bindings required. Works on Linux and Windows with auto-discovered metric fields and Grafana dashboard.
* [HomeLab Monitor](https://github.com/SikamikanikoBG/homelab-monitor) ⭐ 207 | 🐛 14 | 🌐 Python | 📅 2026-09-24 - Self-hosted dashboard that shows which Docker container is actually holding the GPU - per-container VRAM attribution, not just total utilization. Also covers host vitals, Docker health, systemd services, and multiple machines over SSH. MIT license.
...
* [Zabbix](https://github.com/zabbix/zabbix) ⭐ 6,412 | 🐛 109 | 🌐 Go Template | 📅 2026-09-24 - Real-time monitoring of IT components and services, such as networks, servers, VMs, applications and the cloud.
* [DeepFlow](https://github.com/deepflowio/deepflow) ⭐ 4,279 | 🐛 270 | 🌐 Go | 📅 2026-09-21 - Implemented Zero Code data collection with eBPF for metrics, distributed tracing, request logs and function profiling, and is further integrated with SmartEncoding to achieve Full Stack correlation and efficient access to all observability data.
* [Odigos](https://github.com/keyval-dev/odigos) ⭐ 3,675 | 🐛 172 | 🌐 Go | 📅 2026-09-25 - Observability Control Plane.
* [DataBuff](https://github.com/databufflabs/databuff) ⭐ 690 | 🐛 11 | 🌐 Java | 📅 2026-09-16 - Open-source AI-native OpenTelemetry APM with an LLM-powered multi-agent workspace for querying traces, service topology, RED metrics, and alerts in natural language.
...
* [SigNoz](https://github.com/SigNoz/signoz) ⭐ 32,189 | 🐛 1,566 | 🌐 TypeScript | 📅 2026-09-25 - Monitor your applications and troubleshoot problems in your deployed applications, an open-source alternative to DataDog, New Relic, etc.
* [Pinpoint](https://github.com/pinpoint-apm/pinpoint) ⭐ 13,872 | 🐛 544 | 🌐 Java | 📅 2026-09-24 - APM (Application Performance Management) tool for large-scale distributed systems written in Java / PHP/PYTHON.
* [Falcon Plus](https://github.com/open-falcon/falcon-plus) ⚠️ Archived - An open-source and enterprise-level monitoring system.
* [Hubble](https://github.com/cilium/hubble) ⭐ 4,346 | 🐛 44 | 🌐 Makefile | 📅 2026-09-22 - Network, Service & Security Observability for Kubernetes.
...
* [Scouter](https://github.com/scouter-project/scouter) ⭐ 2,178 | 🐛 20 | 🌐 Java | 📅 2026-03-01 - Open source APM (Application Performance Management) tool.
...
* [rrweb](https://github.com/rrweb-io/rrweb) ⭐ 20,212 | 🐛 417 | 🌐 TypeScript | 📅 2026-09-24 - Open-source session replay library that records the DOM and user interactions as a typed JSON event stream and replays them. Powers the session replay features of Sentry, PostHog, Amplitude, and Highlight.
* [App Health](https://github.com/sass-maker/app-health) ⭐ 0 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-23 - Privacy-first endpoint health for Node, Go, and OpenTelemetry services; projects only method, normalized route, status, duration, timestamp, and optional release into aggregate views.
...
* [Grafana tns](https://github.com/grafana/tns) ⭐ 241 | 🐛 28 | 🌐 Jsonnet | 📅 2026-09-25 - Observability Demo App.
...
* [OpenChainBench](https://github.com/ChainBench/OpenChainBench) ⭐ 7 | 🐛 0 | 🌐 Go | 📅 2026-09-25 - Open benchmark stack for Blockchain RPC providers. Multi-region harnesses scrape live tx-landing, latency and finality metrics; Next.js front-end exposes the dashboards and the raw Prometheus data ([website](https://openchainbench.com)).
...
* <https://github.com/Enapiuz/awesome-monitoring> ⭐ 426 | 🐛 20 | 📅 2026-08-04
